package fr.artemis.phone.components.layouts;
...
import fr.artemis.phone.components.layouts.util.FastOutSlowInInterpolator;
...
public class ExpandableLayout extends FrameLayout {
	...
	public interface OnExpansionUpdateListener {
		 ...
		 *
		 * @param expansionFraction Value between 0 (collapsed) and 1 (expanded)
		 *            representing the the expansion progress
