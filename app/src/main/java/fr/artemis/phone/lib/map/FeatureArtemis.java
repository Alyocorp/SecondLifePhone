...
public class FeatureArtemis extends Observable {
	 ...
	 */
	public FeatureArtemis( Geometry featureGeometry, String id, Map<String, Object> properties){
	 ...
	 */
	protected Object removeProperty(String property) {
