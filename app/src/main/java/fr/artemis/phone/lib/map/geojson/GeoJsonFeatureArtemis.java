...
public class GeoJsonFeatureArtemis extends FeatureArtemis implements Observer {

	private final LatLngBounds mBoundingBox;

	private GeoJsonPointStyleArtemis mPointStyle;

	private GeoJsonLineStringStyleArtemis mLineStringStyle;

	private GeoJsonPolygonStyleArtemis mPolygonStyle;
	 ...
	 */
	public GeoJsonFeatureArtemis( Geometry geometry, String id,
								  HashMap<String, Object> properties, LatLngBounds boundingBox ) {
	 ...
	 */
	public Object setProperty( String property, Object propertyValue ) {
	 ...
	 */
	public GeoJsonPointStyleArtemis getPointStyle() {
		return mPointStyle;
	}
	 ...
	 */
	public void setPointStyle( GeoJsonPointStyleArtemis pointStyle ) {
		if ( pointStyle == null ) {
	 ...
	 */
	public GeoJsonLineStringStyleArtemis getLineStringStyle() {
	 ...
	 */
	public void setLineStringStyle( GeoJsonLineStringStyleArtemis lineStringStyle ) {
	 ...
	 */
	public GeoJsonPolygonStyleArtemis getPolygonStyle() {
	 ...
	 */
	public void setPolygonStyle( GeoJsonPolygonStyleArtemis polygonStyle ) {
	 ...
	 */
	private void checkRedrawFeature( GeoJsonStyleArtemis style ) {
	 ...
	 *
	 * @param observable GeoJsonStyleArtemis object
	 * @param data       null, no extra argument is passed through the notifyObservers method
	 */
	@Override
	public void update( Observable observable, Object data ) {
		if ( observable instanceof GeoJsonStyleArtemis ) {
			checkRedrawFeature( (GeoJsonStyleArtemis) observable );
		}
	}
}
