...
public class GeoJsonLayerArtemis extends LayerArtemis {
	 ...
	 */
	public GeoJsonLayerArtemis( GoogleMap map, JSONObject geoJsonFile ) {
		if ( geoJsonFile == null ) {
			throw new IllegalArgumentException( "GeoJSON file cannot be null" );
		}
		mBoundingBox = null;
		GeoJsonParserArtemis parser = new GeoJsonParserArtemis( geoJsonFile );
		// Assign GeoJSON bounding box for FeatureCollection
		mBoundingBox = parser.getBoundingBox();
		HashMap<GeoJsonFeatureArtemis, Object> geoJsonFeatures = new HashMap<>();
		for ( GeoJsonFeatureArtemis feature : parser.getFeatures() ) {
			geoJsonFeatures.put( feature, null );
		}
		GeoJsonRendererArtemis mRenderer = new GeoJsonRendererArtemis( map, geoJsonFeatures );
	 ...
	 */
	public GeoJsonLayerArtemis( GoogleMap map, int resourceId, Context context )
	 ...
	 */
	public Iterable<GeoJsonFeatureArtemis> getFeatures() {
		return (Iterable<GeoJsonFeatureArtemis>) super.getFeatures();
	}
