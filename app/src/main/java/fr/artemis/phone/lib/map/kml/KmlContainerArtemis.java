...
public class KmlContainerArtemis {
	...
	/*package*/ KmlContainerArtemis( HashMap<String, String> properties, HashMap<String, KmlStyleArtemis> styles,
									 HashMap<KmlPlacemarkArtemis, Object> placemarks, HashMap<String, String> styleMaps,
									 ArrayList<KmlContainerArtemis> containers, HashMap<KmlGroundOverlayArtemis, GroundOverlay>
	 ...
	 *                   to the map)
	 */
	/* package */ void setPlacemark( KmlPlacemarkArtemis placemarks, Object object ) {
	 ...
	 */
	/* package */ HashMap<KmlGroundOverlayArtemis, GroundOverlay> getGroundOverlayHashMap() {
	 ...
	 */
	public KmlStyleArtemis getStyle( String styleID ) {
	 ...
	 */
	/*package*/ HashMap<KmlPlacemarkArtemis, Object> getPlacemarksHashMap() {
		return mPlacemarks;
	}
