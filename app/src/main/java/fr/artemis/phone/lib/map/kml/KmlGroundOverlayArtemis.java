...
public class KmlGroundOverlayArtemis {
	 ...
	 */
	/* package */ KmlGroundOverlayArtemis( String imageUrl, LatLngBounds latLonBox, float drawOrder,
										   int visibility, HashMap<String, Object> properties, float rotation) {
	 ...
	 */
	public Object getProperty(String keyValue) {
