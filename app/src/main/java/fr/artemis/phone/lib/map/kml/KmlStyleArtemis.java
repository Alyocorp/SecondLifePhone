...
import fr.artemis.phone.lib.map.StyleArtemis;

public class KmlStyleArtemis extends StyleArtemis {
	 ...
	 */
	/* package */ KmlStyleArtemis( float customColorMarker ) {
		super();
	 ...
	 */
	public static float getHueValue( int integerColor ) {
	 ...
	 */
	private static MarkerOptions createMarkerOptions( MarkerOptions originalMarkerOption, boolean iconRandomColorMode, float markerColor, float customMarkerColor ) {
		...
		if ( iconRandomColorMode ) {
			...
			float hue = getHueValue( (int) customMarkerColor );
			originalMarkerOption.icon( BitmapDescriptorFactory.defaultMarker( hue ) );
		}
	...
	public MarkerOptions getMarkerOptions() {
		return createMarkerOptions( mMarkerOptions, isIconRandomColorMode(), mMarkerColor, mCustomColorMarker );
	}

	public float getCustomColorMarker() {
		return mCustomColorMarker;
	}

	public void setCustomColorMarker(float mCustomColorMarker) {
		this.mCustomColorMarker = mCustomColorMarker;
	}
