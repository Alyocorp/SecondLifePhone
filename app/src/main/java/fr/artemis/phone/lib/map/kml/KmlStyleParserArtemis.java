...
public class KmlStyleParserArtemis {
	 ...
	 */
	/* package */
	static KmlStyleArtemis createStyle( XmlPullParser parser, float customColorMarker )
	throws IOException, XmlPullParserException {
		KmlStyleArtemis styleProperties = new KmlStyleArtemis( customColorMarker );
	...
	static KmlStyleArtemis createStyle( float customColorMarker )  throws IOException, XmlPullParserException {
		KmlStyleArtemis styleProperties = new KmlStyleArtemis( customColorMarker );
//		setStyleId( parser.getAttributeValue( null, "id" ), styleProperties );
//		int eventType = parser.getEventType();
//		while( !( eventType == END_TAG && parser.getName().equals( "Style" ) ) ) {
...
//		}
	 ...
	 */
	private static void setStyleId( String id, KmlStyleArtemis styleProperties ) {
		if( id != null ) {
	 ...
	 */
	private static void createIconStyle( XmlPullParser parser, KmlStyleArtemis style )
	 ...
	 */
	private static void createBalloonStyle( XmlPullParser parser, KmlStyleArtemis style )
	throws XmlPullParserException, IOException {
		int eventType = parser.getEventType();
	 ...
	 */
	private static void setIconUrl( XmlPullParser parser, KmlStyleArtemis style )
	throws XmlPullParserException, IOException {
		int eventType = parser.getEventType();
	 ...
	 */
	private static void setIconHotSpot( XmlPullParser parser, KmlStyleArtemis style ) {
		Float xValue, yValue;
	 ...
	 * @param style Style object to add properties to
	 */
	private static void createLineStyle( XmlPullParser parser, KmlStyleArtemis style )
	throws XmlPullParserException, IOException {
		int eventType = parser.getEventType();
	 ...
	 * @param style Style object to add properties to
	 */
	private static void createPolyStyle( XmlPullParser parser, KmlStyleArtemis style )
	throws XmlPullParserException, IOException {
		int eventType = parser.getEventType();
		while( !( eventType == END_TAG && parser.getName().equals( "PolyStyle" ) ) ) {
			if( eventType == START_TAG ) {
				if( parser.getName().equals( COLOR_STYLE_COLOR ) ) {
					...
					style.setOutline( KmlBooleanArtemis.parseBoolean( parser.nextText() ) );
				} else if( parser.getName().equals( POLY_STYLE_FILL ) ) {
					style.setFill( KmlBooleanArtemis.parseBoolean( parser.nextText() ) );
				} else if( parser.getName().equals( COLOR_STYLE_MODE ) ) {
