...
/**
 * Tache de suppression d'une demande d'equipement de salarié
 */
public class AppelWsDeleteEquipementSalarie extends AbstractCaller<Boolean> {

	// L'identifiant de l'equipment a supprimer
	 ...
	 */
	public AppelWsDeleteEquipementSalarie( WsCaller source, Map<String, Object> mapResources, WsName name ) {
	...
	protected Boolean executionRequete() {
		...
		SoapObject requete = new SoapObject( ConstantesWS.NAMESPACE, ConstantesWS.METHOD_DELETE_EQUIPEMENT_SALARIE );
