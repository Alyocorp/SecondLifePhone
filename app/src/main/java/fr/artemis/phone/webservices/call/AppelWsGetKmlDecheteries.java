 ...
 */
public class AppelWsGetKmlDecheteries extends AbstractCaller<String> {
	 ...
	 */
	public AppelWsGetKmlDecheteries( WsCaller source, Map<String, Object> mapResources, WsName name ) {
	...
	protected String executionRequete() {
		...
		SoapObject requete = new SoapObject( ConstantesWS.NAMESPACE, ConstantesWS.METHOD_GET_KML_DECHETERIES );
