...
/**
 * Tache de recuperation de la liste des equipements des salariés
 */
public class AppelWsGetListeEquipementsSalarie extends AbstractCaller<List<CRMPhoneEquipementSalarieDTO>> {
	 ...
	 */
	public AppelWsGetListeEquipementsSalarie( WsCaller source, Map<String, Object> mapResources, WsName name ) {
	...
	protected List<CRMPhoneEquipementSalarieDTO> executionRequete() {
		...
		SoapObject requete = new SoapObject( ConstantesWS.NAMESPACE, ConstantesWS.METHOD_LISTE_EQUIPEMENTS_SALARIE );
