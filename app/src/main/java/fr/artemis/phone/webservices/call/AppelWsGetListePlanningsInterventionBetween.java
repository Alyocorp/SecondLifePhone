...
/**
 * Recuperation de la liste des intervention entre 2 dates
 */
public class AppelWsGetListePlanningsInterventionBetween extends AbstractCaller<List<CRMPhonePlanningDTO>> {
	 ...
	 */
	public AppelWsGetListePlanningsInterventionBetween( WsCaller source, Map<String, Object> mapResources, WsName name ) {
	...
	protected List<CRMPhonePlanningDTO> executionRequete() {
		...
		SoapObject requete = new SoapObject( ConstantesWS.NAMESPACE, ConstantesWS.METHOD_LISTE_PLANNING_INTER_BETWEEN );
	...
	private String parseContent() {
		...
		sbContent.append( "<web:getListePlanningInterventionBetween>" );
