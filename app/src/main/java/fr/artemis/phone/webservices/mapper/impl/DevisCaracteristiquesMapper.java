...
/**
 * Classe de mapping d'une caracteristique de devis
 */
public class DevisCaracteristiquesMapper extends AbstractDefaultMapper<CRMPhoneDevisCaracteristiqueDTO> {

	@Override
	public CRMPhoneDevisCaracteristiqueDTO map( SoapObject objectToMap ) {
		CRMPhoneDevisCaracteristiqueDTO dto = null;

		if ( null != objectToMap && objectToMap.getPropertyCount() > 0 ) {
			dto = new CRMPhoneDevisCaracteristiqueDTO();
