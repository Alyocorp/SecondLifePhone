package fr.artemis.phone.weekview;
...
import static fr.artemis.phone.weekview.WeekViewUtil.isSameDay;
import static fr.artemis.phone.weekview.WeekViewUtil.today;
...
public class WeekView extends View {
	...
	private int mHeaderRowBackgroundColor = Color.rgb( 48, 48, 48 );
	private int mDayBackgroundColor = Color.rgb( 48, 48, 48 );
	private int mPastBackgroundColor = Color.rgb( 48, 48, 48 );
	private int mFutureBackgroundColor = Color.rgb( 48, 48, 48 );
	...
	private int mHeaderColumnBackgroundColor = Color.rgb( 48, 48, 48 );
	private boolean mIsFirstDraw = true;
	private boolean mAreDimensionsInvalid = true;
	@Deprecated
	private int mDayNameLength = LENGTH_LONG;
	private int mOverlappingEventGap = 4;
	private int mEventMarginVertical = 2;
...
//        canvas.clipRect(mHeaderColumnWidth, 0, getWidth(), mHeaderHeight + mHeaderRowPadding * 2, Region.Op.REPLACE);
	 ...
	 * </p>
	 *
	 * @param length Supported values are {@link fr.artemis.phone.weekview.WeekView#LENGTH_SHORT} and
	 *               {@link fr.artemis.phone.weekview.WeekView#LENGTH_LONG}.
	 */
	@Deprecated
	...
	public interface EventLongPressListener {
		/**
		 * Similar to {@link fr.artemis.phone.weekview.WeekView.EventClickListener} but with a long press.
		 *
		 * @param event:     event clicked.
		 * @param eventRect: view containing the clicked event.
		 */
	...
	public interface EmptyViewLongPressListener {
		/**
		 * Similar to {@link fr.artemis.phone.weekview.WeekView.EmptyViewClickListener} but with long press.
		 *
